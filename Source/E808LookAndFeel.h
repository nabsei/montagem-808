...
// Same Montagem brand palette as the rest of the chain: dark background,
// red = "tight/short", green = "deep/long". The knob arc interpolates
// between them as the single "amount" parameter increases, so the color
// itself communicates the character instead of a plain gray dial.
