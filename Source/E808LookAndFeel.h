...
// logo): cyan = "tight/short"/idle, magenta = "deep/long"/engaged. The
// knob arc interpolates between them as the single "amount" parameter
// increases, so the color itself communicates the character instead of a
// plain gray dial -- same cyan=calm/magenta=intense convention used
// across the whole catalogue, not a Montagem-specific red/green.
class E808LookAndFeel : public juce::LookAndFeel_V4
{
public:
